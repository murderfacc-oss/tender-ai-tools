"""
[DEPRECATED] Собирает плагин tender-ai.plugin для Claude Code.

В текущем флоу не используется — от плагинного пути дистрибуции отказались
в пользу раздельной установки (см. INSTALL.md и pack_skills.py). Скрипт
оставлен в репо для истории и на случай возврата к плагинной модели.
